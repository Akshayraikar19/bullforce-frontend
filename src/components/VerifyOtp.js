...
const VerifyOtp = () => {
  ...
  return (
    <div className="login-background d-flex justify-content-center align-items-center vh-100 p-3">
      <Card style={{
        maxWidth: "100%",
        width: "100%",
        maxWidth: "500px",
        ...
        <CardBody>
          <CardTitle tag="h3" className="text-center">
            <img src={bullLogo} alt="Bull Logo" className="img-fluid" style={{ width: "150px", height: "auto" }} />
          </CardTitle>
          ...
          <Form onSubmit={(e) => { e.preventDefault(); handleOTPVerification(); }}>
            <FormGroup className="d-flex justify-content-center gap-2">
              {otp.map((digit, index) => (
                <Input
                  key={index}
                  id={`otp-${index}`}
